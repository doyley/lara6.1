								...
								<div class="row mb-3 d-flex justify-content-center pl-3 pr-3">
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-1 pl-1 pr-1">
										<div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 btn btn-lg btn-lkin">
											<a href="{{ lurl('auth/linkedin') }}" class="btn-lkin"><i class="icon-linkedin"></i> {!! t('Connect with LinkedIn') !!}</a>
										</div>
									</div>
									@endif
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-1 pl-1 pr-1">
										<div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 btn btn-lg btn-tw">
											<a href="{{ lurl('auth/twitter') }}" class="btn-tw"><i class="icon-twitter-bird"></i> {!! t('Connect with Twitter') !!}</a>
										</div>
									</div>
									@endif
						...
						<div class="card card-default">
							...
							<div class="card-body">
								...
								@if (
									...
									and config('settings.security.recaptcha_public_key')
            						and config('settings.security.recaptcha_private_key')
								)
									<!-- recaptcha -->
