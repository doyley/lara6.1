		...
		if (auth()->check()) {
			if (isFromAdminPanel()) {
				...
				if (
					...
					!\Illuminate\Support\Str::contains(\Route::currentRouteAction(), 'Post\CreateController') &&
					!\Illuminate\Support\Str::contains(\Route::currentRouteAction(), 'Post\EditController') &&
					!\Illuminate\Support\Str::contains(\Route::currentRouteAction(), 'Post\PhotoController') &&
					!\Illuminate\Support\Str::contains(\Route::currentRouteAction(), 'Post\PaymentController') &&
...
function getSegment($index, $default = null)
{
	...
	if (!\Illuminate\Support\Str::endsWith(request()->url(), '.xml')) {
